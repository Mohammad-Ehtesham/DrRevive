...
import femaleDoctorImage from "../../assets/femaleDoctor.jpg"; // Import a default image
import MaleDoctorImage from "../../assets/doctormen.png"; // Import a default image
...
function Doc() {
  ...
  const [doctorsData] = useState([
    ...
    },
    {
      ...
      experience: 13,
      language: ["Hindi", "English"],
      hospital: "Institute of Mental Health, Delhi",
      imageUrl: MaleDoctorImage,
      rating: 4.7,
    },
    {
      ...
      experience: 16,
      language: ["Hindi", "English", "Marathi"],
      hospital: "Sankara Eye Hospital, Mumbai",
      imageUrl: femaleDoctorImage,
      rating: 4.9,
    },
  ]);
